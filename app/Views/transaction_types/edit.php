        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="<?= base_url('transaction-types/update/' . $transaction_type['id']) ?>" method="POST">
                        <?= csrf_field() ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control <?= session('errors.name') ? 'is-invalid' : '' ?>"
                                        id="name" name="name" value="<?= old('name', $transaction_type['name']) ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control <?= session('errors.category') ? 'is-invalid' : '' ?>"
                                        ...
                                        <?php foreach ($categories as $key => $label): ?>
                                            <option value="<?= $key ?>"
                                                <?= old('category', $transaction_type['category']) == $key ? 'selected' : '' ?>>
                                                <?= $label ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control <?= session('errors.description') ? 'is-invalid' : '' ?>"
                                        ...
                                        placeholder="Nhập mô tả chi tiết về loại giao dịch này"><?= old('description', $transaction_type['description']) ?></textarea>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control <?= session('errors.sort_order') ? 'is-invalid' : '' ?>"
                                        ...
                                        value="<?= old('sort_order', $transaction_type['sort_order']) ?>"
                                        placeholder="0" min="0">
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Cập nhật loại giao dịch
                            </button>
