...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="card-box">
                <h4 class="m-t-0 header-title">Chỉnh sửa bảng giá cộng tác viên</h4>
                ...
                <form action="<?= base_url('affiliate-pricing/update/' . $pricing['id']) ?>" method="POST">
                    <?= csrf_field() ?>
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" id="aff_id" name="aff_id" required>
                                ...
                                <?php foreach ($affiliates as $affiliate): ?>
                                    <option value="<?= $affiliate['id'] ?>" <?= ($affiliate['id'] == $pricing['aff_id']) ? 'selected' : '' ?>>
                                        <?= $affiliate['fullname'] ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" id="order_code" name="order_code" required>
                                ...
                                <?php foreach ($orderCodes as $order): ?>
                                    <option value="<?= $order['order_code'] ?>" <?= ($order['order_code'] == $pricing['order_code']) ? 'selected' : '' ?>>
                                        <?= $order['order_code'] ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control" id="aff_price_per_kg" name="aff_price_per_kg" required min="0" value="<?= $pricing['aff_price_per_kg'] ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control" id="aff_price_per_cubic_meter" name="aff_price_per_cubic_meter" required min="0" value="<?= $pricing['aff_price_per_cubic_meter'] ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="date" class="form-control" id="start_date" name="start_date" required value="<?= $pricing['start_date'] ?>">
                        </div>
